...
const NativeMediaStatsSchema = Schema.Struct({
  ...
  rtpPacketsSent: Schema.optional(Schema.Finite),
  rtpBytesSent: Schema.optional(Schema.Finite),
  rtpFramesSent: Schema.optional(Schema.Finite),
  rtpFramesEncoded: Schema.optional(Schema.Finite),

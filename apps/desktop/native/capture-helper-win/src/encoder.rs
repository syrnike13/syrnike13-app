pub use crate::openh264_encoder::OpenH264Encoder;
...
pub struct VideoEncoder {
    ...
    mf: Option<crate::mf_encoder::MfH264Encoder>,
...
impl VideoEncoder {
    pub fn new(width: u32, height: u32, bitrate: u32) -> Result<(Self, EncoderBackend), String> {
        if let Ok(mf) = crate::mf_encoder::MfH264Encoder::try_new(width, height, bitrate) {
            return Ok((
                Self {

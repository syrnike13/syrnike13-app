    ...
    <div className="space-y-2">
      ...
      >
        ...
        <SettingsRow
          ...
          hint="При сбое голоса или демонстрации экрана отправляет ограниченный структурированный пакет без токенов, адресов комнат, содержимого сообщений, аудио и экрана. Изменение подробных native-логов вступит в силу после перезапуска приложения."
        >
          <Switch
            checked={

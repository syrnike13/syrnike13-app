...
auto_derived!(
    ...
    pub struct DataEditServer {
        ...
        // Whether this server is age-restricted
        // nsfw: Option<bool>,
        /// Whether this server is public and should show up on [syrnike13 Discover](https://rvlt.gg)
        pub discoverable: Option<bool>,
        /// Whether analytics should be collected for this server
        ///
        /// Must be enabled in order to show up on [syrnike13 Discover](https://rvlt.gg).

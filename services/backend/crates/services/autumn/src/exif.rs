...
pub async fn strip_metadata(
    ...
    match &metadata {
        Metadata::Image {
            ...
            //     let metadata = syrnike_little_exif::metadata::Metadata::new_from_path_with_filetype(
            //         file.path(),
            //         match mime {
            //             "image/jpeg" => syrnike_little_exif::filetype::FileExtension::JPEG,
            //             "image/png" => syrnike_little_exif::filetype::FileExtension::PNG {
            //                 as_zTXt_chunk: true,
            //             },
            //             _ => unreachable!(),
            //         },

...
use syrnike_database::{Channel, Interactions, Message, AMQP};
use syrnike_models::v0;
use syrnike_models::v0::ChannelSlowmode;
...
pub async fn message_send(
    ...
    let model_user = user
        .clone()
        .into_known_static(syrnike_presence::is_online(&user.id).await)
        .await;
...
mod test {
    ...
    use syrnike_models::v0::{self, DataCreateServerChannel, MessageFlags};

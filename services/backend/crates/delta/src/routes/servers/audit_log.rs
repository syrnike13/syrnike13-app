...
fn parse_audit_action(action: Option<String>) -> Result<Option<ServerAuditLogAction>> {
    let action = match action.as_deref() {
        ...
        Some("ChannelCreate") => ServerAuditLogAction::ChannelCreate,
        Some("ChannelUpdate") => ServerAuditLogAction::ChannelUpdate,
        Some("ChannelDelete") => ServerAuditLogAction::ChannelDelete,

module github.com/syrnike13/livekit-server
...
replace github.com/livekit/protocol => github.com/stoatchat/livekit-protocol v0.0.0-20251023140146-6a2a05af5917

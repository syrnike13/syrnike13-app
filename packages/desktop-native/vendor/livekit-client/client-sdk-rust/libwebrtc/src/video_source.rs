...
pub mod native {
    ...
    impl NativeVideoSource {
        ...
        /// Creates a Windows D3D11 hardware-only source.
        ///
        /// Unlike a regular native source, this source never emits synthetic
        /// I420 frames while it waits for the first captured D3D11 texture.
        #[cfg(target_os = "windows")]
        pub fn new_d3d11_hardware(resolution: VideoResolution, is_screencast: bool) -> Self {
            Self {
                handle: vs_imp::NativeVideoSource::new_d3d11_hardware(resolution, is_screencast),
            }
        }

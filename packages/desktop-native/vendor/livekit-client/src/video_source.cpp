...
VideoSource::VideoSource(int width, int height, bool is_screencast)
    : VideoSource(width, height, is_screencast, SourceMode::Default) {}

VideoSource::VideoSource(int width, int height, bool is_screencast, SourceMode mode) : width_(width), height_(height) {
  ...
  msg->set_is_screencast(is_screencast);
  msg->set_mode(mode == SourceMode::D3D11Hardware ? proto::VideoSourceMode::VIDEO_SOURCE_MODE_D3D11_HARDWARE
                                                  : proto::VideoSourceMode::VIDEO_SOURCE_MODE_DEFAULT);

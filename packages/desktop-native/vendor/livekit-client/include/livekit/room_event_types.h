...
/// Video codec values mirror `proto::VideoCodec` exactly.
...
/// Exact encoder backend requested for a published video track.
...
struct TrackPublishOptions {
  ...
  /// Explicit values are strict: publishing fails when the backend is absent.

...
export interface paths {
  ...
  "/feedback/mine": {
    get: operations["feedback_mine"];
  };
  "/feedback/{id}": {
    get: operations["feedback_detail"];
  };
  "/feedback/{id}/vote": {
    put: operations["feedback_add_vote"];
    delete: operations["feedback_remove_vote"];
  };
  "/feedback/admin/pending": {
    get: operations["feedback_admin_pending"];
  };
  "/feedback/admin/{id}/approve": {
    post: operations["feedback_admin_approve"];
  };
  "/feedback/admin/{id}/reject": {
    post: operations["feedback_admin_reject"];
  };
  "/feedback/admin/{id}/merge": {
    post: operations["feedback_admin_merge"];
  };
...
export interface components {
  schemas: {
    ...
    SyrnikeConfig: {
      /** @description syrnike13 API Version */
      syrnike: string;
      /** @description Features enabled on this syrnike13 node */
      features: components["schemas"]["SyrnikeFeatures"];
    ...
    Message: {
       ...
       *
       * https://docs.rs/syrnike-models/latest/syrnike_models/v0/enum.MessageFlags.html
       */
      flags?: number;
    };
    ...
    FetchServerResponse: Partial<components["schemas"]["Server"]> &
      Partial<{
        /** @description Channels within this server */
        channels: string[];
        /** @description Unique Id */
    ...
    DataEditServer: {
       ...
       */
      flags?: number | null;
      /** @description Whether this server is public and should show up on [syrnike13 Discover](https://rvlt.gg) */
    ...
    MemberResponse: Partial<components["schemas"]["Member"]> &
      Partial<{
        member: components["schemas"]["Member"];
        roles: { [key: string]: components["schemas"]["Role"] };
      }>;
...
export interface operations {
  ...
  root_root: {
    responses: {
      200: {
        content: {
          "application/json": components["schemas"]["SyrnikeConfig"];
        };
      };
      /** An error occurred. */
      default: {

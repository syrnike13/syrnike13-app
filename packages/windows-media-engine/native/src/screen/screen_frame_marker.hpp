...
inline constexpr std::uint16_t kScreenMarkerMagic = 0x534e;
inline constexpr std::size_t kScreenMarkerPayloadBits = 144;
inline constexpr std::size_t kScreenMarkerBits = 160;
inline constexpr std::size_t kScreenMarkerColumns = 24;
inline constexpr std::size_t kScreenMarkerRows = 7;
